## Supported Release [2.4.1]
### Summary
Including Debian 10 release support and maintaining compatibility with puppet version requirement >=4.7.0 and <6.0.0A

### Added
- Support for java packages in Debian 10
